> **Historical note (September 2026).** This is the argument the project started from, written
> in June 2025 and left unedited. The backtest in the [README](../README.md) tested it against
> two months of Kalshi prices in 2026 and found the opposite: the market was better calibrated
> and sharper than a model trained on NBM guidance and METAR observations, at every hour of the
> day and in every city. The volume numbers below are also out of date — the series were
> migrated to The Weather Company settlement in July 2026 and trade far more than they did.
