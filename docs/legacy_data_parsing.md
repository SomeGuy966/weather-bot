> **Historical note.** This described the 1-minute ASOS parsing plan from June 2025. That
> data source was dropped — see [`data_sources.md`](data_sources.md) for why — and the
> feature table is now built from METARs. Kept for the record.
